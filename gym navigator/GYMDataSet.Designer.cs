...
namespace gym_navigator {
    ...
    public partial class GYMDataSet : global::System.Data.DataSet {
        ...
        public partial class membersDataTable : global::System.Data.TypedTableBase<membersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public membersRow AddmembersRow(string name, string phone, string sex, string address, string reason) {
...
namespace gym_navigator.GYMDataSetTableAdapters {
    ...
    public partial class membersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[members] WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_sex = 1 AND [sex] IS NULL) OR ([sex] = @Original_sex)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_reason = 1 AND [reason] IS NULL) OR ([reason] = @Original_reason)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[members] ([name], [phone], [sex], [address], [reason]) VALUES " +
                "(@name, @phone, @sex, @address, @reason);\r\nSELECT id, name, phone, sex, address," +
                " reason FROM members WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[members] SET [name] = @name, [phone] = @phone, [sex] = @sex, [address] = @address, [reason] = @reason WHERE (([id] = @Original_id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_phone = 1 AND [phone] IS NULL) OR ([phone] = @Original_phone)) AND ((@IsNull_sex = 1 AND [sex] IS NULL) OR ([sex] = @Original_sex)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_reason = 1 AND [reason] IS NULL) OR ([reason] = @Original_reason)));
SELECT id, name, phone, sex, address, reason FROM members WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, phone, sex, address, reason FROM dbo.members";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_phone, string Original_sex, string Original_address, string Original_reason) {
        ...
        public virtual int Insert(string name, string phone, string sex, string address, string reason) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string phone, string sex, string address, string reason, int Original_id, string Original_name, string Original_phone, string Original_sex, string Original_address, string Original_reason, int id) {
            if ((name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string phone, string sex, string address, string reason, int Original_id, string Original_name, string Original_phone, string Original_sex, string Original_address, string Original_reason) {
            return this.Update(name, phone, sex, address, reason, Original_id, Original_name, Original_phone, Original_sex, Original_address, Original_reason, Original_id);
        }
    }
